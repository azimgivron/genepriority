...
from NEGradient_GenePriority import bedroc_score, Results, Evaluation
...
def create_results():
    ...
    return [
        Results(np.array([1, 0, 1, 0, 1]), np.array([0.9, 0.1, 0.8, 0.4, 0.7])),
        Results(np.array([0, 1, 1, 0, 1]), np.array([0.3, 0.85, 0.65, 0.2, 0.9])),
    ]
