...
def main():
    ...
    try:
        ...
        # )
        import pickle
        with open("/home/TheGreatestCoder/code/output/omim1_results.pickle", 'rb') as f:
            omim1_results = pickle.load(f)
        with open("/home/TheGreatestCoder/code/output/omim2_results.pickle", 'rb') as f:
            omim2_results = pickle.load(f)
        ############################
